...
class TestCloudTrailChecker(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.mock_clients = {"cloudtrail": Mock(), "sts": Mock()}
        self.config = {}
    ...
    def test_determine_severity_critical(self):
        ...
        anomalies = [{"event_name": "root", "severity": "CRITICAL"}]
    ...
    def test_determine_severity_high(self):
        ...
        anomalies = [{"event_name": "CreateAccessKey", "severity": "HIGH"}]
    ...
    def test_get_remediation_suggestion(self):
        ...
        anomalies = [
            {"event_name": "CreateAccessKey", "severity": "HIGH"},
            {"event_name": "AttachUserPolicy", "severity": "HIGH"},
        ]
...
class TestCloudTrailCheckerIntegration(unittest.TestCase):
    ...
    def test_full_check_workflow(self):
        ...
        mock_sts.get_caller_identity.return_value = {"Arn": "arn:aws:iam::123456789:user/test"}
