...
class TestIAMChecker(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.mock_clients = {"iam": Mock(), "dynamodb_resource": self.mock_dynamodb_resource}
    ...
    def test_check_no_changes(self):
        ...
        self.checker._get_iam_users = Mock(
            return_value={
                "user1": {
        ...
        self.checker._get_baseline = Mock(
            return_value={
                "users": {
                    "user1": {
                        "arn": "arn:aws:iam::123:user/user1",
    ...
    def test_check_new_user_detected(self):
        ...
        self.checker._get_baseline = Mock(
            return_value={"users": baseline_users, "keys": {"user1": []}}
        )
    ...
    def test_check_new_access_key_detected(self):
        ...
        self.checker._get_baseline = Mock(
            return_value={"users": {"user1": {}}, "keys": baseline_keys}
        )
    ...
    def test_get_baseline_existing(self):
        ...
        self.mock_dynamodb_table.get_item.return_value = {
            "Item": {"users": json.dumps({"user1": {}}), "keys": json.dumps({"user1": []})}
        }
    ...
    def test_determine_severity_medium(self):
        ...
        changes = [{"type": "NEW_USER", "severity": "HIGH"}]
    ...
    def test_determine_severity_low(self):
        ...
        changes = [{"type": "NEW_ACCESS_KEY", "severity": "MEDIUM"}]
