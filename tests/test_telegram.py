...
class TestTelegramResponder(unittest.TestCase):
    ...
    def test_send_message_success(self, mock_post):
        ...
        responder = TelegramResponder(bot_token=self.bot_token, chat_id=self.chat_id)
    ...
    def test_send_ec2_alert_format(self, mock_post):
        ...
        ec2_data = {
            "unauthorized_region_instances": {"ap-southeast-1": [{"InstanceId": "i-12345"}]},
            "exposed_instances": [
                {
                    "instance_id": "i-67890",
                    "region": "us-east-1",
            ...
            "new_instances": [{"instance_id": "i-99999", "region": "us-west-2"}],
            ...
            "public_buckets": [
                {
                    ...
                    "public_reasons": [
                        ...
                        "Bucket policy allows public write",
                    ],
                }
            ],
            "new_buckets": [{"bucket_name": "new-bucket"}],
            "anomalies": [1],
        }
    ...
    def test_send_auto_response_notification(self, mock_post):
        ...
        result = responder.send_auto_response_notification("stop_ec2", "i-12345678", "success")
        self.assertTrue(result)

        result = responder.send_auto_response_notification("block_s3_public", "my-bucket", "failed")
        self.assertTrue(result)
...
class TestTelegramResponderInit(unittest.TestCase):
    ...
    def test_init_with_explicit_params(self):
        ...
        responder = TelegramResponder(bot_token="explicit-token", chat_id="explicit-chat-id")
